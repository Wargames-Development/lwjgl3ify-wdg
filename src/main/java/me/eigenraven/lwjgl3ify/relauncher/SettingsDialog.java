...
public class SettingsDialog {
    ...
    public JCheckBox optUseBundledJava;
    public JLabel lblBundledStatus;
    ...
    public void loadTranslations() {
        ...
        optUseBundledJava.setText(translations.getString(TranslationsBundle.KEY_USE_BUNDLED_JAVA));
    ...
    private void $$$setupUI$$$() {
        ...
        optUseBundledJava = new JCheckBox();
        optUseBundledJava.setText("KEY_USE_BUNDLED_JAVA");
        gbc = new GridBagConstraints();
        gbc.gridx = 2;
        gbc.gridy = 1;
        gbc.gridwidth = 4;
        ...
        gbc.fill = GridBagConstraints.HORIZONTAL;
        rootPanel.add(optUseBundledJava, gbc);
        lblBundledStatus = new JLabel();
        lblBundledStatus.setText("KEY_BUNDLED_JAVA_STATUS");
        gbc = new GridBagConstraints();
        gbc.gridx = 2;
        gbc.gridy = 2;
        gbc.gridwidth = 4;
        gbc.anchor = GridBagConstraints.WEST;
        gbc.fill = GridBagConstraints.HORIZONTAL;
        rootPanel.add(lblBundledStatus, gbc);
