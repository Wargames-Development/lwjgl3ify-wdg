...
Packaged Java 21 installation/selection and DistantHorizons-WDG integration are planned later. They are **not implemented by Change 001**. Existing upstream relauncher and launcher behavior is unchanged.
